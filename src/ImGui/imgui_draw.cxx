...
void ImDrawList::AddConvexPolyFilled(const ImVec2* points, const int points_count, ImU32 col, bool anti_aliased)
{
    ...
    if (anti_aliased)
    {
        ...
        for (int i0 = points_count-1, i1 = 0; i1 < points_count; i0 = i1++)
        {
            ...
            ImVec2 diff = p1 - p0;
            diff *= ImInvLength(diff, 1.0f);
            temp_normals[i1] = diff;
        }

        for (int i0 = 0, i1 = 1; i0 < points_count; i1 = (++i0 + 1) % points_count)
        {
            // Average normals
            const ImVec2& n0 = temp_normals[i0];
            const ImVec2& n1 = temp_normals[i1];
            ImVec2 dm = (n0 - n1);
            dm *= ImInvLength(dm, 1.0f);
            dm *= AA_SIZE * 0.5f;
            ...
            _IdxWritePtr[0] = (ImDrawIdx)(vtx_inner_idx+(i0<<1)); _IdxWritePtr[1] = (ImDrawIdx)(vtx_inner_idx+(i1<<1)); _IdxWritePtr[2] = (ImDrawIdx)(vtx_outer_idx+(i0<<1));
