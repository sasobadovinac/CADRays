...
vlight clear
vlight add directional direction 1 -1 -2 head 0

vdisplay case
vsetmaterial case aluminium

vdisplay title
vsetmaterial title plaster
vbsdf title -kd 0

# board is mostly yellow (edges, triangle markers)
foreach f [explode board f] { vdisplay $f; vsetmaterial $f gold; }
# top and bottom faces are light-green (outside) and dark-green (inside)
vsetmaterial board_4 plaster; vbsdf board_4 -kd 0 0.6 0.55
vsetmaterial board_5 plaster; vbsdf board_5 -kd 0 0.6 0.55
vsetmaterial board_12 plaster; vbsdf board_12 -kd 0 0.3 0.33
vsetmaterial board_14 plaster; vbsdf board_14 -kd 0 0.3 0.33

vdisplay rpads
vsetmaterial rpads gold

vdisplay bpads
vsetmaterial bpads gold

vdisplay brpk
vsetmaterial brpk gold
